...
- Base layout + responsive navigation header
...
- ⬜ Experience page — Construction placeholder
- ⬜ Designs page — Construction placeholder
- ⬜ Certificates page — Construction placeholder
...
- ✅ Admin dashboard overview (with Firestore counts) — DONE
- ✅ AdminNavDock (floating navigation + FAB + image modal) — DONE
- ✅ AdminLayout wrapper — DONE
- ⬜ Admin workspace pages (all stubs, no CRUD yet)
- ⬜ React island CRUD operations
