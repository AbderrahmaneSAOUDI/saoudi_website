...
18. **Mandatory End-of-Prompt Git Automation:** At the conclusion of every prompt, stage all changes (`git add .`), commit with a descriptive message (`git commit -m "what happens here"`), and push to the remote repository (`git push`).
